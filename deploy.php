...
// Config
set('application', 'Laravel Asgard CMS Web Application');                          // The Application Title
set('repository', 'git@abbeysoftware.github.com:Mark-AbbeySoftware/asgard.git');   // SCM Target
set('keep_releases',
...
host('prod')
    ...
    ->set('deploy_path', '/var/www/asgard/prod')
...
host('stage')
    ...
    ->set('remote_user', 'mag')
    ->set('identityFile', '~/.ssh/id_rsa')
    ->set('deploy_path', '/var/www/asgard/stage')
    ->set('writable_use_sudo', false)
    ->set('use_relative_symlink', true)
    ->set('http_user', 'mag')
    ->set('branch', 'stage')
