...
namespace AbbeySoftwareDevelopment\Sidebar\Tests\Traits;

use AbbeySoftwareDevelopment\Sidebar\Domain\DefaultItem;
use AbbeySoftwareDevelopment\Sidebar\Itemable;
...
class ItemableTraitTest extends TestCase
{
    ...
    {
        $mock = m::mock('AbbeySoftwareDevelopment\Sidebar\Item');
        $mock->shouldReceive('name');
        $mock->shouldReceive('getName')->andReturn($name);
        $mock->shouldReceive('getWeight')->andReturn($weight);

        $this->container->shouldReceive('make')->with('AbbeySoftwareDevelopment\Sidebar\Item')->andReturn(
            $mock
        );
