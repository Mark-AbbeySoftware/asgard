...
class DefaultItemTest extends TestCase
{
    ...
    public function test_can_instantiate_new_item()
    {
        ...
        $this->assertInstanceOf('AbbeySoftwareDevelopment\Sidebar\Item', $item);
    }
    ...
    public function test_item_can_be_cached()
    {
        ...
        $this->assertInstanceOf('AbbeySoftwareDevelopment\Sidebar\Item', $unserialized);
    ...
    {
        $mock = m::mock('AbbeySoftwareDevelopment\Sidebar\Badge');

        $this->container->shouldReceive('make')->with('AbbeySoftwareDevelopment\Sidebar\Badge')->andReturn(
            $mock
        );
    ...
    {
        $mock = m::mock('AbbeySoftwareDevelopment\Sidebar\Append');

        $this->container->shouldReceive('make')->with('AbbeySoftwareDevelopment\Sidebar\Append')->andReturn(
            $mock
        );
