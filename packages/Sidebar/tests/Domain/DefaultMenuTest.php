...
class DefaultMenuTest extends TestCase
{
    ...
    public function test_can_instantiate_new_menu()
    {
        ...
        $this->assertInstanceOf('AbbeySoftwareDevelopment\Sidebar\Menu', $menu);
    }
    ...
    public function test_menu_can_be_cached()
    {
        ...
        $this->assertInstanceOf('AbbeySoftwareDevelopment\Sidebar\Menu', $unserialized);
    ...
    {
        $mock = m::mock('AbbeySoftwareDevelopment\Sidebar\Group');
        $mock->shouldReceive('name');
        $mock->shouldReceive('getName')->andReturn($name);
        $mock->shouldReceive('getWeight')->andReturn($weight);

        $this->container->shouldReceive('make')->with('AbbeySoftwareDevelopment\Sidebar\Group')->andReturn(
            $mock
        );
